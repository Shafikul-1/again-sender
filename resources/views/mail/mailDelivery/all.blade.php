    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class=" border-b  dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600  {{ ($details->status == 'success') ? 'bg-green-700' : 'bg-red-600'}}">
                    <td class="w-4 p-4">
                        <div class="flex items-center">
                    ...
                    <td class="px-6 py-4">
                        <x-form action="{{ route('maildelivery.destroy', $details->id) }}" method="DELETE">
                            <button type="submit">
