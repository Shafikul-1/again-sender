<x-app-layout>
    ...
    <x-form action="{{ route('sendingemails.update', $sendingEmails->id) }}" method="POST" :fields="[
        [
            'type' => 'text',
            'name' => 'mails',
            'id' => 'mails',
        ...
        [
            ...
            'errorClass' => $errorClass,
            'value' => $sendingEmails->mail_content[0]['mail_subject'],
            'wrapper' => [
                'class' => $wrapper,
            ],
            'attributes' => [
        ...
        [
            ...
            'errorClass' => $errorClass,
            'value' => $sendingEmails->mail_content[0]['mail_body'],
            'wrapper' => [
                'class' => $wrapper,
            ],
            'attributes' => [
