<x-app-layout>
    @section('title', 'Add Sending Email')
    @php
    ...
    <x-form action="{{ route('sendingemails.store') }}" method="POST" :fields="[
        ...
        <x-model>
            <div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-8 relative">
                ...
                <input type="hidden" id="mail_previse_file" name="mail_previse_file" class="mail_previse_file">
        ...
        <div class="space-y-4">
            ...
            <div>
                <x-texteditor name="mail_body" rows="25" cols="40" class="w-full border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('mail_body') }}"/>
            </div>
